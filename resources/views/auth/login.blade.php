@extends('layouts.auth', ['class' => 'login-page', 'page' => _('Login Page'), 'contentClass' => 'login-page'])
    ...
    <form class="form" method="post" action="{{ route('login') }}">
        ...
        <div class="card card-login card-white">
            <!-- <div class="card-header">
                <img src="{{ asset('img/logo.png') }}" alt="" height="200px">
            ...
            <div class="card-body text-center">
                ...
                <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <input type="hidden" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ _('Email') }}" value="admin">
